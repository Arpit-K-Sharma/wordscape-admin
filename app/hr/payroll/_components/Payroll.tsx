...
const Payrolls: React.FC = () => {
  ...
  useEffect(() => {
    if (selectedMonth && selectedMonth !== "all") {
      const filtered = payrollManagement.filter(
            ...
            <Table className="w-full bg-white border border-grey-900 rounded-lg shadow-sm">
              <TableHeader>
                <TableRow className="bg-gray-800">
                  <TableHead className="text-center py-2 px-4 font-semibold text-white">
                    Employee Name
                  </TableHead>
                  <TableHead className="text-center py-2 px-4 font-semibold text-white">
                    Month
              ...
              <TableBody>
                {filteredPayroll.map((payroll) => (
                  ...
                  >
                    ...
                    <TableCell className="text-center py-2 px-4">
                      {months
                        .filter((month) => month.value == payroll.month)
                    ...
                    <TableCell className="text-center py-2 px-4">
                      Rs. {payroll.sub_total}
                    </TableCell>
                    <TableCell className="text-center py-2 px-4">
                      Rs. {payroll.tax}
                    </TableCell>
                    <TableCell className="text-center py-2 px-4">
                      Rs. {payroll.net_salary}
                    </TableCell>
                    {/* <TableCell>
                      <Button
                      variant="destructive"
