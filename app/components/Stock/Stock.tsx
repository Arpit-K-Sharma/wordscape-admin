...
import { stockService } from "@/app/services/hrServices/stockService";
          ...
          <CardHeader className="border-b border-gray-200">
            <CardTitle className="text-xl font-bold text-black">
              <div className="flex flex-row justify-between">
                <div>Inventory Stock Levels</div>
                <div>
                  <Button
                    onClick={() =>
                      handleOpenForm("addType", "6697898fae9ff72cee6b1ee7")
                    }
                  ...
                  {inventoryData &&
                    inventoryData.map((inventoryType) => (
                      <div
                        ...
                        className="shadow-sm rounded-md p-[20px]"
                      >
                        <div className="flex flex-row justify-between">
                          <div>
                          ...
                          <div>
                            ...
                            <Button
                              onClick={() =>
                                handleOpenForm("add", inventoryType._id)
                              }
                              disabled={isSubmitting}
                              className="font-semibold text-[15px]"
                            >
                                    ...
                                    <div>
                                      ...
                                      >
                                        <DialogContent>
                                          <DialogHeader>
                                            <DialogTitle>
                                              Delete Category Form Inventory
                                            </DialogTitle>
                                            <DialogDescription>
                                      ...
                                      <Dialog
                                        open={
                                          openDialogId === inventoryType._id
                                        }
                                        onOpenChange={(open) =>
                                          setOpenDialogId(inventoryType._id)
                                        }
                                      >
