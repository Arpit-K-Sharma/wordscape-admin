    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 p-4 overflow-auto">
        <div className="flex gap-0">
          <h1 className="text-3xl  font-bold mt-[30px] mb-3 mr-[80px] text-gray-800">
            Leftover Items{" "}
          </h1>
                ...
                <HoverCardContent className="w-[300px] rounded-[20px]">
                  <div className="p-[10px] items-center justify-center font-archivo">
                    ...
                    <p className=" ml-[20px] text-left text-gray-600 text-[15px]">
                      This page provides information about the leftover items
                      that were added to the inventory after the work was
                      finished.
                    </p>
                  </div>
                </HoverCardContent>
