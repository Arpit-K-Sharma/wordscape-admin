...
export default function JobcardMenu({ orderId }: JobcardMenuProps) {
  ...
  const orderDetailsArray = orderDetails
    ? [
        ...
        {
          icon: FaCut,
          label: "Cover Treatment Type",
          value: orderDetails.coverTreatmentType,
        },
        {
          icon: FaPaintBrush,
          label: "Inner Paper Type",
          value: orderDetails.innerPaperType,
        },
        {
          icon: FaLayerGroup,
          label: "Inner Paper Thickness",
          value: orderDetails.innerPaperThickness,
        },
        {
          icon: FaPaintBrush,
          label: "Outer Paper Type",
          value: orderDetails.outerPaperType,
        },
        {
          icon: FaLayerGroup,
          label: "Outer Paper Thickness",
          value: orderDetails.outerPaperThickness,
        },
        {
          icon: FaPrint,
          label: "Inner Lamination Type",
          value: orderDetails.innerLamination,
        },
        {
          icon: FaPrint,
          label: "Outer Lamination Type",
          value: orderDetails.outerLamination,
        },
        { icon: FaTint, label: "Ink Type", value: orderDetails.inkType },
        {
          icon: FaComment,
          label: "Remarks",
          value: orderDetails.remarks || "N/A",
        },
