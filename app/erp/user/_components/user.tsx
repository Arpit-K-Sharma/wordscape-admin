...
import {
  ...
  addUser,
  updateUser,
} from "../../../services/erpServices/userService";
      ...
      <div className="flex-grow overflow-auto">
        <div className="p-7 text-black">
          <div className="flex items-center justify-center mb-8">
            <h1 className="text-center text-4xl font-archivo font-semibold">
              Staffs
            </h1>
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  <p>
                    This page displays a list of all staff members and allows
                    you to manage them.
                  </p>
                </TooltipContent>
              </Tooltip>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-[#131527] hover:bg-[#131527]">
                    ...
                    <TableHead className="w-[10px] text-white">
                      Actions
                    </TableHead>
                  </TableRow>
                </TableHeader>
